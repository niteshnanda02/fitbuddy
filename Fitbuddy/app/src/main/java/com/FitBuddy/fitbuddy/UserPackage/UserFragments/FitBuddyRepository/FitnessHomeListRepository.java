...
public class FitnessHomeListRepository {


    static FitnessHomeListRepository instance;
    List<SessionsDetails> sessionsDetails = new ArrayList<>();
    MutableLiveData<List<SessionsDetails>> detailslist = new MutableLiveData<>();

    public static FitnessHomeListRepository getInstance() {


        if (instance == null)
            instance = new FitnessHomeListRepository();
