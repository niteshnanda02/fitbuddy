...
public class YogaHomeListRepository {



    static YogaHomeListRepository instance;
    ...
    public static YogaHomeListRepository getInstance() {


        if (instance == null)
            instance = new YogaHomeListRepository();
